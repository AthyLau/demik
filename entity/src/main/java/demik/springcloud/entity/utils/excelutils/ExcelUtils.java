...
public class ExcelUtils
{
            ...
            throws IOException, Exception
    {
        ...
        for (int f = 0; f < fields.length; f++)
        {
            ...
            boolean fieldHasAnno = fields[f].isAnnotationPresent(IsNeed.class);
            // 有注解
            if (fieldHasAnno)
            {
                IsNeed annotation = fields[f].getAnnotation(IsNeed.class);
                boolean isNeeded = annotation.isNeed();
    ...
    private static Object getEntityMemberValue(Object realValue, Field[] fields, int f, String cellValue)
    {
        ...
        if ("char".equals(type) || "java.lang.Character".equals(type) || "java.lang.String".equals(type)) {
            realValue = cellValue;
        ...
        } else if ("int".equals(type) || "float".equals(type) || "double".equals(type) || "java.lang.Double".equals(type) || "java.lang.Float".equals(type) || "java.lang.Long".equals(type) || "java.lang.Short".equals(type) || "java.math.BigDecimal".equals(type)) {
            realValue = StringUtils.isBlank(cellValue) ? null : new BigDecimal(cellValue);

        } else if("java.lang.Boolean".equals(type)){
            realValue = StringUtils.isBlank(cellValue) ? null : new Boolean(cellValue);
        }
        return realValue;
    }
